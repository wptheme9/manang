...
// - Contributor: Phil Earley
// - Release date: 26 July 2016
// - GitHub: https://github.com/cephil/jAudio.js
//
// # ----- Contact info
// - GitHub: https://github.com/cephil
//
// # ----- License Info
// - Inhereited from source author's GPL v3 license.
//
// # Pull Request Overview:
// - This fork & pending pull request (upon completion of tasks)
// - implements the volume controls missing from the original source.
// - Instead of using a library, I've implemented the native HTML5 range
// - input with a dummy fill track (which gets updated upon 'input' event).
// - Some styling tweaks added, for personal taste (and project needs), as
// - Well as debugging and performance testing (IE11+ testing pending).
//
// # Change log:
...
(function($) {
    ...
    function Plugin($context, options) {
        ...
        // this.$domVolumeBar = this.$context.find(".jAudio--volume-bar");
        this.$domVolumeBar = this.$context.find("#jAudio--volume-slider");
    ...
    this.$detailsThumb = this.$context.find(".jAudio--album-cover");
    ...
    Plugin.prototype = {
        ...
        prev: function() {
            ...
            (self.currentTrack === 0) ?
            track = self.settings.playlist.length - 1: track = self.currentTrack - 1;
        ...
        next: function() {
            ...
            track = 0: track = self.currentTrack + 1;
    ...
    changeVolume: function(value) {
      ...
      self.domAudio.volume = value;
      self.$domVolumeBar.prev().css('width', percent + '%').attr('data-volume', percent);
    },
        ...
        events: function() {
            ...
            // - volume's bar events
            // change event for IE11+ & debounce
      self.$domVolumeBar.on("input", function(e) {
        self.changeVolume(e.currentTarget.value);
      });
        ...
        renderPlaylist: function() {
            ...
            $.each(self.settings.playlist, function(i, a) {
                ...
                template += "</div>";
        template += "<div class='jAudio--playlist-item-progress'></div>"
      ...
      percentage = percentage < 10 ? '0' + Math.floor(percentage.toString()) : percentage.toString();
            self.$domProgressBar.children().eq(0).attr('data-percent', percentage).css(styles);
      self.$domPlaylist.children('.active').children('.jAudio--playlist-item-progress').css(styles);
        },
