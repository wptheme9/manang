...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" />
                ...
                <div class="pricing__price"><span class="pricing__currency">$</span>35<span class="pricing__period">/ mo</span></div>
                <h3 class="pricing__title">Personal</h3>
            </div>
            <ul class="pricing__feature-list">
                <li class="pricing__feature">Free Support</li>
                <li class="pricing__feature">5 GB of space</li>
                <li class="pricing__feature">Up to 10 User Access</li>
                <li class="pricing__feature">Free Update</li>
            </ul>
...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" />
                ...
                <div class="pricing__price"><span class="pricing__currency">$</span>78<span class="pricing__period">/ mo</span></div>
                <h3 class="pricing__title">Business</h3>
            </div>
            <ul class="pricing__feature-list">
                <li class="pricing__feature">Free Support</li>
                <li class="pricing__feature">10 GB of space</li>
                <li class="pricing__feature">Up to 20 User Access</li>
                <li class="pricing__feature">Free Update</li>
            </ul>
            <button class="pricing__action">Choose plan</button>
        </div>
...
c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z" />
                ...
                <div class="pricing__price"><span class="pricing__currency">$</span>150<span class="pricing__period">/ mo</span></div>
                <h3 class="pricing__title">Premium</h3>
            </div>
            <ul class="pricing__feature-list">
                <li class="pricing__feature">Free Support</li>
                <li class="pricing__feature">17 GB of space</li>
                <li class="pricing__feature">Up to 20 User Access</li>
                <li class="pricing__feature">Free Update</li>
            </ul>
            <button class="pricing__action">Choose plan</button>
