...
function manang_scripts() {
   ...
   wp_enqueue_script( 'manang-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
    wp_enqueue_script( 'jquery-ui', 'http://code.jquery.com/ui/1.11.1/jquery-ui.min.js', array(), '20151215', true );
   ...
   wp_enqueue_script( 'fullscreen', get_template_directory_uri() . '/assets/js/fullscreen.js',array(), '20170124', true );
    ...
    wp_enqueue_script( 'mmenu', get_template_directory_uri() . '/assets/js/mmenu.js',array(), '20170302', true );
...
require get_template_directory() . '/vc-elements/mg-feature.php';
require get_template_directory() . '/vc-elements/mg-cta.php';
require get_template_directory() . '/vc-elements/mg-testimonial.php';
require get_template_directory() . '/vc-elements/mg-team.php';
require get_template_directory() . '/vc-elements/mg-fancybox.php';
require get_template_directory() . '/vc-elements/mg-pricing.php';
require get_template_directory() . '/vc-elements/mg-fact-counter.php';
require get_template_directory() . '/vc-elements/mg-section-title.php';
require get_template_directory() . '/vc-elements/mg-clients.php';
require get_template_directory() . '/vc-elements/mg-latest-post.php';
