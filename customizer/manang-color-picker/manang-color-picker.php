...
class Customize_Opacity_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'manang-color-picker',
			get_template_directory_uri() . '/customizer/manang-color-picker/manang-color-picker.js',
		...
		wp_enqueue_style(
			'manang-color-picker',
			get_template_directory_uri() . '/customizer/manang-color-picker/manang-color-picker.css',
